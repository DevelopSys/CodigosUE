...
export class DataService {
  ...
  public getPostByIdURL(id: number): Observable<any> {
    return this.clienteHttp.get(`https://dummyjson.com/posts/${id}`);
  }

  public getAllPostTagURL(tag: string): Observable<any> {
